...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2  -DFT_CONFIG_OPTION_SYSTEM_ZLIB -I/usr/include/libpng12 -DFT_CONFIG_OPTION_USE_PNG -I/usr/include/harfbuzz -DFT_CONFIG_OPTION_USE_HARFBUZZ -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
